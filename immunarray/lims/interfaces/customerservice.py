...
class ICustomerServiceFolder(Interface):
    """Marker interface for a folder which contains Customer Service
    Clients objects
    """
...
class ICustomerServiceItem(model.Schema):
    """Pull all techs and managers and put into a list, use that as the values
    list for MaterialReciviedBy and MaterialOpenedBy
    """
